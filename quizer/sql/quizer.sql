...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 28 juin 2020 à 20:38
...
(2, 1, 0, '$_SERVER[]'),
(3, 1, 0, '$_FILE[]'),
(4, 2, 0, 'Create Myfunction'),
(5, 2, 0, 'Myfunction Create'),
(6, 2, 1, 'function myFunc()\r\n'),
(7, 2, 0, 'New Function()'),
(8, 3, 0, '0'),
(9, 3, 0, '2'),
(10, 3, 0, '3'),
...
(15, 4, 0, 'PHP'),
(16, 5, 0, 'Un point \".\"'),
(17, 5, 1, 'Un point d\'interrogation \"?\"'),
(18, 5, 0, 'Un point d\'exclamation \"!\"\r\n\r\n\r\n'),
(19, 5, 0, 'Une esperluette \"&\'');
